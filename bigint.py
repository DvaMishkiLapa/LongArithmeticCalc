...
def GCD(a, b):
    ...
    while a and b:
        ...
        if a > b:
            # то находить остаток от деления его на второе число и присваивать его первой переменной,
            a = a % b
        # иначе, (когда второе число больше первого),
        else:
            # присваивать второй переменной остаток от деления нацело второго числа на первое
            b = b % a
